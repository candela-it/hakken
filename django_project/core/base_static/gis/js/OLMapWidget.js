...
function MapWidget(options) {
    ...
    this.layers.vector.events.on({'featuremodified': this.add_wkt, scope: this});
    this.layers.vector.events.on({'featureadded': this.add_wkt, scope: this});
    this.layers.vector.events.on({'sketchcomplete': this.add_wkt, scope: this});
...
MapWidget.prototype.getControls = function(layer) {
    ...
    if (this.options.geom_name == 'MultiPolygon' || this.options.geom_name == 'Unknown') {
        this.controls.push(new OpenLayers.Control.DrawFeature(layer, OpenLayers.Handler.Polygon, {
