...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.area_of_interest'
        db.alter_column(u'projects_project', 'area_of_interest', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.area_of_interest'
        db.alter_column(u'projects_project', 'area_of_interest', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(default=''))
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'area_of_interest': ('django.contrib.gis.db.models.fields.MultiPolygonField', [], {'null': 'True', 'blank': 'True'}),
